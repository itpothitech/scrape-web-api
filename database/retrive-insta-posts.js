const InstaProfile = require("../models/insta-profile");
...
const RetrieveInstaPosts = async (userName, tag, fromDate, toDate) => {
  try {
    let userProfile = [];
...
exports.RetrieveInstaPosts = RetrieveInstaPosts;
